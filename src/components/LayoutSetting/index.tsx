...
const LayoutSetting: React.FC = (props) => {
  ...
  return ReactDOM.createPortal(
    <>
      <div
        className={classNames('RCS-setting-drawer', openSetting && 'RCS-setting-drawer-opened')}
        id="raSettingMask"
      >
        <div className="RCS-setting-drawer-mask" onClick={() => handleOpenSetting(false)}></div>
        <div className="RCS-setting-drawer-wrapper">
          <SettingOutlined
            className="RCS-setting-icon"
            onClick={() => handleOpenSetting(!openSetting)}
          />
          <div className="RCS-setting-drawer-body">
            <CloseOutlined
              className="RCS-setting-drawer-closeIcon"
