import { hex2rgb, rgb2hsl, hsl2lighten, hsl2darken, hsl2fade, color2tint } from './tools';
import { defaultDarkTheme, defaultLightTheme } from '@config/setting';
import cloneDeep from 'lodash/cloneDeep';

export function changeTheme(visionTheme: string, currentColor: string, callback?: () => void) {
